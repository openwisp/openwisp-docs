...
project = "OpenWISP"
copyright = f"2008-{date.today().year}, OpenWISP"
...
html_favicon = "assets/design/favicon.svg"
...
htmlhelp_basename = "openwisp-docs"
...
latex_documents = [
    (master_doc, "openwisp-docs.tex", "OpenWISP", "OpenWISP Community", "manual")
]
...
man_pages = [(master_doc, "openwisp-docs", "OpenWISP Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "OpenWISP Documentation",
        "Comprehensive user and developer documentation for OpenWISP.",
        "Miscellaneous",
    )
]
