...
- Bumped ``black`` to 26.5.1 (``>=25.1,<26.6``)
  ...
  permit the latest version. See the `release notes
  <https://github.com/psf/black/releases>`__, `changelog
  <https://github.com/psf/black/blob/main/CHANGES.md>`__, and `commit
  comparison <https://github.com/psf/black/compare/25.1.0...26.5.1>`__.

- Bumped ``celery`` to 5.6.1 (``~=5.6.1``)

  Updates the requirements on `celery
  <https://github.com/celery/celery>`__ to permit the latest version. See
  the `release notes <https://github.com/celery/celery/releases>`__,
  `changelog
  <https://github.com/celery/celery/blob/main/Changelog.rst>`__, and
  `commit comparison
  <https://github.com/celery/celery/compare/v5.5.3...v5.6.1>`__.
...
- Bumped ``djangorestframework`` to 3.17.1 (``~=3.17.1``)
  ...
  <https://github.com/encode/django-rest-framework/releases>`__ and
  `commit comparison
...
- Bumped ``git-cliff`` to 2.13.1 (``~=2.13.1``)
  ...
  See the `release notes <https://github.com/orhun/git-cliff/releases>`__,
  `changelog
  <https://github.com/orhun/git-cliff/blob/main/CHANGELOG.md>`__, and
  `commit comparison
...
- Bumped ``isort`` to 8.0.1 (``>=6.0.1,<8.1.0``)
  ...
  to permit the latest version. See the `release notes
  <https://github.com/PyCQA/isort/releases>`__, `changelog
  <https://github.com/PyCQA/isort/blob/main/CHANGES.rst>`__, and `commit
  comparison <https://github.com/PyCQA/isort/compare/6.0.1...8.0.1>`__.
...
- Bumped ``pytest-asyncio`` to 1.4.0 (``>=1.3.0,<1.5.0``)
  ...
  <https://github.com/pytest-dev/pytest-asyncio/releases>`__ and `commit
  comparison
...
- Bumped ``selenium`` to 4.46.0 (``>=4.32,<4.47``)
  ...
  <https://github.com/SeleniumHQ/Selenium/blob/main/Changelog.rst>`__, and
  `commit comparison
...
- Bumped ``django-filter`` to 26.1 (``>=25.1,<27.0``)
  ...
  version. See the `release notes
  <https://github.com/django-filter/releases>`__, `changelog
  <https://github.com/django-filter/blob/main/CHANGES.rst>`__, and `commit
  comparison <https://github.com/django-filter/compare/25.1...26.1>`__.
...
- Bumped ``coverage`` to 7.15.2 (``>=7.10.0,<7.16.0``)
  ...
  <https://github.com/coveragepy/coverage/blob/main/CHANGES.rst>`__, and
  `commit comparison
...
- Added ``@sentry/node`` `^10.40.0
  <https://github.com/getsentry/sentry-javascript/releases/tag/10.40.0>`__.
