...
`Django apps
<https://docs.djangoproject.com/en/4.0/intro/reusable-apps/>`_, Django is
...
<https://docs.djangoproject.com/en/4.0/topics/settings/>`_, a file which
...
respective README documentation files of each module, for a list of all
the available modules please see :doc:`Architecture, Modules, Technologies
